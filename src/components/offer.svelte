<script>
  ...
  const offers = [
    ...
    },
    {
      ...
      title: "Balance Cleared on the 5th Day",
      description: "The remaining 25% amount is paid promptly within 5 days to ensure complete trust and maintain farmer liquidity.",
      badge: "On Time",
      delay: 400
    },
    {
